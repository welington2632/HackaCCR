<template>
  <div class="home">
    ...
    <SharedAsideMenu>
      ...
      <SharedAsideItem text="Inicio" :active="false">
        <template v-slot:icon
          ...
          >
            ...
            <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" fill="#444" /></svg
        ></template>
      </SharedAsideItem>
      <SharedAsideItem text="Aprenda" to="/aprenda" :active="true">
        <template v-slot:icon
          ><svg
            xmlns="http://www.w3.org/2000/svg"
            height="40"
    ...
    <div class="content">
      ...
      <SharedSection sectionName="Treinamentos">
        <SharedLearnCard
          :Empresa="{ nome: 'Grupo CCR', logo: 'ccr.png' }"
          :Post="{
            createdDate: '2 dias atrás',
            title: 'Conheça nosso programa de jovens funcionários',
            subtitle:
        ...
        <SharedLearnCard
          :Empresa="{ nome: 'Shawee', logo: 'shawee.jpeg' }"
          :Post="{
            createdDate: '10 horas atrás',
            title: 'Aprenda a inovar de maneira colaborativa',
            subtitle:
              'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
          }"
        >
        ...
        <SharedLearnCard
          :Empresa="{ nome: 'Shawee', logo: 'shawee.jpeg' }"
          :Post="{
            createdDate: '5 dias atrás',
            title: 'Dicas para novos hackathons',
            subtitle:
              'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
          }"
        >
...
import SharedLearnCard from "../components/SharedLearnCard.vue";
